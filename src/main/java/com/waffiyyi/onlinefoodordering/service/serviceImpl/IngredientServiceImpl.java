...
public class IngredientServiceImpl implements IngredientService {
  ...
  public IngredientCategory createIngredientCategory(String name, Long restaurantId) {
    ...
    if (name == null || name.isEmpty()) {
      throw new BadRequestException("Ingredient Category Name cannot be empty",
  ...
  public IngredientCategory findIngredientCategoryById(Long id) {
    return ingredientCategoryRepository.findById(id).orElseThrow(
       () -> new ResourceNotFoundException("Ingredient Category not found",
  ...
  public IngredientsItem updateStock(Long id) {
    IngredientsItem ingredientsItem = ingredientItemRepository.findById(id).orElseThrow(
       () -> new ResourceNotFoundException("Ingredient item not found",
                                           HttpStatus.NOT_FOUND));
